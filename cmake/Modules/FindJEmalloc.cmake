...
find_path(JEmalloc_LIB_DIR libjemalloc.so
  ${JEMALLOC_ROOT}/lib
  ${PC_JEMALLOC_LIBDIR} 
...
find_library(JEmalloc_LIBRARY
  NAME ${JEmalloc_NAME}
  PATHS ${JEMALLOC_ROOT}/lib ${PC_JEMALLOC_LIBDIR} ${PC_JEMALLOC_LIBRARY_DIRS} /usr/lib /usr/local/lib /opt/local/lib ${LD_LIBRARY_PATH_STR}
)
